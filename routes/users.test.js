...
describe('POST /users', function () {
  ...
  test('Fail Post for Unauthorized User', async function () {
    const resp = await request(app)
      .post('/users')
      .send({
        username: 'u-new',
...
describe('GET /users', function () {
  ...
  test('Fail Get for Unauthorized User', async function () {
    const resp = await request(app)
      .get('/users')
      .set('authorization', `Bearer ${u2Token}`);
    expect(resp.statusCode).toEqual(401);
...
describe('PATCH /users/:username', () => {
  ...
  test('Fail Patch Not Admin or User', async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
        firstName: 'New',
...
describe('POST /users/:username/jobs/:id', function () {
  test('Admin Test', async function () {
    const resp = await request(app)
